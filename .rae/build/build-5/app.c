...
int main(int argc, char** argv) {
  ...
  helper.is_owned = 0;
  rae_Bool saveRequested = (bool)false;
  ...
  if (saveRequested) {
  rae_Bool saved = (__extension__ ({ rae_String __rae_pw_6 = (__extension__ ({ rae_String __rae_pw_7 = (rae_String){(uint8_t*)"rae_render", 10}; rae_renderPath_rae_View_String_((rae_View_String){ .ptr = &__rae_pw_7 }); })); rae_ext_image_savePng((rae_View_String){ .ptr = &__rae_pw_6 }, fb.data, width, height); }));
