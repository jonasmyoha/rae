...
int main(int argc, char** argv) {
  ...
  rae_Bool saved = (__extension__ ({ rae_String __rae_pw_3 = (__extension__ ({ rae_String __rae_pw_4 = (rae_String){(uint8_t*)"rae_render", 10}; rae_renderPath_rae_View_String_((rae_View_String){ .ptr = &__rae_pw_4 }); })); rae_ext_image_savePng((rae_View_String){ .ptr = &__rae_pw_3 }, fb.data, width, height); }));
  }
  ...
  tris = (__extension__ ({ rae_String __rae_pw_5 = rae_ext_rae_str_interp(3, (rae_String){(uint8_t*)"", 0}, rae_string_borrow(dir), (rae_String){(uint8_t*)"assets/bunny.obj", 16}); rae_loadObjTriangles_rae_View_String_rae_View_Float64_rae_View_Float64_rae_View_Float64_rae_View_Float64_rae_View_Bool_rae_Material_((rae_View_String){ .ptr = &__rae_pw_5 }, 4.0, 0.0, 3.6, 0.9, (bool)true, &bunnyMat); }));
  } else {
  ...
  rt = (__extension__ ({ rae_String __rae_pw_6 = wgsl; rae_buildGpuRT_rae_View_String_rae_List_double_rae_List_double_rae_List_double_rae_List_double_rae_List_double_rae_List_int64_t_rae_View_Int64_((rae_View_String){ .ptr = &__rae_pw_6 }, ((rae_List_double[1]){ rae_sceneFloats_rae_Camera_rae_List_rae_Sphere_(&cam, &world) }), ((rae_List_double[1]){ rae_boxFloats_rae_List_rae_Box_(&boxes) }), ((rae_List_double[1]){ rae_triFloats_rae_List_rae_Triangle_(&tris) }), &sceneGpu.nodes, &sceneGpu.refs, &params, width * height); }));
  ...
  { int __rae_spm = rae_string_pool_mark(); rae_set_int64_t_rae_List_int64_t_rae_View_Int64_int64_t_(&params, ((int64_t)0LL), width); rae_string_pool_flush(__rae_spm); }
  { int __rae_spm = rae_string_pool_mark(); rae_set_int64_t_rae_List_int64_t_rae_View_Int64_int64_t_(&params, ((int64_t)1LL), height); rae_string_pool_flush(__rae_spm); }
  rt = (__extension__ ({ rae_String __rae_pw_7 = wgsl; rae_buildGpuRT_rae_View_String_rae_List_double_rae_List_double_rae_List_double_rae_List_double_rae_List_double_rae_List_int64_t_rae_View_Int64_((rae_View_String){ .ptr = &__rae_pw_7 }, ((rae_List_double[1]){ rae_sceneFloats_rae_Camera_rae_List_rae_Sphere_(&cam, &world) }), ((rae_List_double[1]){ rae_boxFloats_rae_List_rae_Box_(&boxes) }), ((rae_List_double[1]){ rae_triFloats_rae_List_rae_Triangle_(&tris) }), &sceneGpu.nodes, &sceneGpu.refs, &params, width * height); }));
  ...
  { int __rae_spm = rae_string_pool_mark(); (__extension__ ({ rae_String __rae_pw_8 = helper; rae_drawLabel_rae_Buffer_int64_t_rae_View_Int64_rae_View_Int64_rae_SdfFont_rae_View_String_rae_View_Float64_rae_View_Float64_rae_View_Float64_(fb.data, width, height, &font, (rae_View_String){ .ptr = &__rae_pw_8 }, 12.0, baseY, textPx); })); rae_string_pool_flush(__rae_spm); }
  ...
  double fpsW = (__extension__ ({ rae_String __rae_pw_9 = fpsStr; rae_sdfMeasureText_rae_SdfFont_rae_View_String_rae_View_Float64_(&font, (rae_View_String){ .ptr = &__rae_pw_9 }, textPx); }));
  { int __rae_spm = rae_string_pool_mark(); (__extension__ ({ rae_String __rae_pw_10 = fpsStr; rae_drawLabel_rae_Buffer_int64_t_rae_View_Int64_rae_View_Int64_rae_SdfFont_rae_View_String_rae_View_Float64_rae_View_Float64_rae_View_Float64_(fb.data, width, height, &font, (rae_View_String){ .ptr = &__rae_pw_10 }, rae_toFloat_rae_View_Int64_(width) - fpsW - 12.0, baseY, textPx); })); rae_string_pool_flush(__rae_spm); }
