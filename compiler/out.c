...
int main(void) {
  ...
  rae_StringMap_int64_t m = rae_createStringMap_int64_t_int64_t_(((int64_t)4LL));
  ...
  rae_IntMap_rae_String m2 = rae_createIntMap_rae_String_int64_t_(((int64_t)4LL));
...
RAE_UNUSED static rae_StringMap_int64_t rae_createStringMap_int64_t_int64_t_(int64_t initialCap) {
  {
  return (rae_StringMap_int64_t){ .data = (void*)rae_ext_rae_buf_alloc(initialCap, sizeof(rae_StringMapEntry_int64_t)), .length = ((int64_t)0LL), .capacity = initialCap, .isGrowing = (bool)false };
  }
}
...
RAE_UNUSED static void rae_set_int64_t_rae_StringMap_int64_t_rae_String_int64_t_(rae_StringMap_int64_t* this, rae_String k, int64_t value) {
  ...
  this->data = (void*)rae_ext_rae_buf_alloc(this->capacity, sizeof(rae_StringMapEntry_int64_t));
  }
  }
  if ((bool)(((bool)!(this->isGrowing)) && (bool)(this->length * ((int64_t)2LL) > this->capacity))) {
  {
...
RAE_UNUSED static void rae_set_rae_String_rae_IntMap_rae_String_int64_t_rae_String_(rae_IntMap_rae_String* this, int64_t k, rae_String value) {
  ...
  {
  this->capacity = ((int64_t)8LL);
  this->data = (void*)rae_ext_rae_buf_alloc(this->capacity, sizeof(rae_IntMapEntry_rae_String));
  }
  }
  if ((bool)(((bool)!(this->isGrowing)) && (bool)(this->length * ((int64_t)2LL) > this->capacity))) {
  {
  ...
  int64_t maxIter = this->capacity;
  int64_t iter = ((int64_t)0LL);
  {
  while ((bool)true) {
  {
  ...
  idx = (idx + ((int64_t)1LL)) % this->capacity;
  iter = iter + ((int64_t)1LL);
  if ((bool)(iter > maxIter)) {
  {
  return;
  }
  }
...
RAE_UNUSED static void rae_growStringMap_int64_t_rae_StringMap_int64_t_(rae_StringMap_int64_t* this) {
  ...
  this->isGrowing = (bool)false;
  }
}

RAE_UNUSED static rae_IntMap_rae_String rae_createInt64Map_rae_String_int64_t_(int64_t initialCap) {
  {
  return (rae_IntMap_rae_String){ .data = (void*)rae_ext_rae_buf_alloc(initialCap, sizeof(rae_IntMapEntry_rae_String)), .length = ((int64_t)0LL), .capacity = initialCap, .isGrowing = (bool)false };
  }
}
