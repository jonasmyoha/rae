...
static const Keyword KEYWORDS[] = {
    ...
    {"else", TOK_KW_ELSE},   {"false", TOK_KW_FALSE}, {"func", TOK_KW_FUNC},
    {"if", TOK_KW_IF},       {"is", TOK_KW_IS},       {"match", TOK_KW_MATCH},
    {"mod", TOK_KW_MOD},     {"none", TOK_KW_NONE},   {"not", TOK_KW_NOT},
    {"opt", TOK_KW_OPT},     {"or", TOK_KW_OR},       {"own", TOK_KW_OWN},
    {"priv", TOK_KW_PRIV},   {"pub", TOK_KW_PUB},     {"ret", TOK_KW_RET},
    {"spawn", TOK_KW_SPAWN}, {"true", TOK_KW_TRUE},   {"type", TOK_KW_TYPE},
    {"view", TOK_KW_VIEW}};
