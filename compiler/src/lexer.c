...
static const Keyword KEYWORDS[] = {
    ...
    {"if", TOK_KW_IF},       {"import", TOK_KW_IMPORT},
    {"in", TOK_KW_IN},       {"is", TOK_KW_IS},
    {"let", TOK_KW_LET},     {"var", TOK_KW_VAR},     {"const", TOK_KW_CONST},
    {"enum", TOK_KW_ENUM},
    {"loop", TOK_KW_LOOP},    {"match", TOK_KW_MATCH},
    {"mod", TOK_KW_MOD},     {"none", TOK_KW_NONE},    {"not", TOK_KW_NOT},
    {"bitand", TOK_KW_BITAND}, {"bitor", TOK_KW_BITOR},  {"bitxor", TOK_KW_BITXOR},
    {"bitnot", TOK_KW_BITNOT}, {"shl", TOK_KW_SHL},      {"shr", TOK_KW_SHR},
...
static const char* const TOKEN_KIND_NAMES[] = {
    ...
    [TOK_KW_ALIAS] = "TOK_ALIAS",
    [TOK_KW_FUNC] = "TOK_FUNC",
    [TOK_KW_LET] = "TOK_LET",
    [TOK_KW_VAR] = "TOK_VAR",
    [TOK_KW_CONST] = "TOK_CONST",
    [TOK_KW_RET] = "TOK_RET",
    ...
    [TOK_KW_OR] = "TOK_OR",
    [TOK_KW_NOT] = "TOK_NOT",
    [TOK_KW_BITAND] = "TOK_BITAND",
    [TOK_KW_BITOR] = "TOK_BITOR",
    [TOK_KW_BITXOR] = "TOK_BITXOR",
    [TOK_KW_BITNOT] = "TOK_BITNOT",
    [TOK_KW_SHL] = "TOK_SHL",
    [TOK_KW_SHR] = "TOK_SHR",
    [TOK_KW_IS] = "TOK_IS",
    [TOK_KW_PUB] = "TOK_PUB",
