...
static const Keyword KEYWORDS[] = {
    ...
    {"band", TOK_KW_BAND},   {"bor", TOK_KW_BOR},     {"bxor", TOK_KW_BXOR},
    {"bnot", TOK_KW_BNOT},   {"bsl", TOK_KW_BSL},     {"bsr", TOK_KW_BSR},
...
static const char* const TOKEN_KIND_NAMES[] = {
    ...
    [TOK_KW_OR] = "TOK_OR",
    [TOK_KW_NOT] = "TOK_NOT",
    [TOK_KW_BAND] = "TOK_BAND",
    [TOK_KW_BOR] = "TOK_BOR",
    [TOK_KW_BXOR] = "TOK_BXOR",
    [TOK_KW_BNOT] = "TOK_BNOT",
    [TOK_KW_BSL] = "TOK_BSL",
    [TOK_KW_BSR] = "TOK_BSR",
    [TOK_KW_IS] = "TOK_IS",
    [TOK_KW_PUB] = "TOK_PUB",
