...
typedef struct { int64_t* ptr; } rae_View_Int64; typedef struct { int64_t* ptr; } rae_Mod_Int64;
typedef struct { int32_t* ptr; } rae_View_Int32; typedef struct { int32_t* ptr; } rae_Mod_Int32;
typedef struct { uint64_t* ptr; } rae_View_UInt64; typedef struct { uint64_t* ptr; } rae_Mod_UInt64;
typedef struct { uint32_t* ptr; } rae_View_UInt32; typedef struct { uint32_t* ptr; } rae_Mod_UInt32;
typedef struct { double* ptr; } rae_View_Float64; typedef struct { double* ptr; } rae_Mod_Float64;
typedef struct { float* ptr; } rae_View_Float32; typedef struct { float* ptr; } rae_Mod_Float32;
typedef struct { rae_Bool* ptr; } rae_View_Bool; typedef struct { rae_Bool* ptr; } rae_Mod_Bool;
typedef struct { uint32_t* ptr; } rae_View_Char32; typedef struct { uint32_t* ptr; } rae_Mod_Char32;
typedef struct { uint32_t* ptr; } rae_View_Char; typedef struct { uint32_t* ptr; } rae_Mod_Char;
typedef struct { rae_String* ptr; } rae_View_String; typedef struct { rae_String* ptr; } rae_Mod_String;
...
int main(void);
RAE_UNUSED static rae_List_rae_String rae_createList_int64_t_(int64_t initialCap);
RAE_UNUSED static void rae_add_rae_List_rae_String_rae_String_(rae_List_rae_String* this, rae_String value);
RAE_UNUSED static int64_t rae_sizeof_(void);
RAE_UNUSED static void rae_grow_rae_List_rae_String_(rae_List_rae_String* this);
...
RAE_UNUSED static rae_List_rae_String rae_split_rae_String_rae_String_(rae_String this, rae_String sep) {
  {
  rae_List_rae_String result = rae_createList_int64_t_(((int64_t)4LL));
  if ((bool)(rae_length_rae_String_(sep) == ((int64_t)0LL))) {
  {
  rae_add_rae_List_rae_String_rae_String_(&(result), this);
  return result;
  }
  }
  ...
  {
  rae_add_rae_List_rae_String_rae_String_(&(result), remaining);
  return result;
  }
  }
  rae_String part = rae_sub_rae_String_int64_t_int64_t_(remaining, ((int64_t)0LL), idx);
  rae_add_rae_List_rae_String_rae_String_(&(result), part);
...
RAE_UNUSED static rae_String rae_join_rae_List_rae_String_rae_String_(rae_List_rae_String* this, rae_String sep) {
  {
  if ((bool)(rae_length_rae_List_rae_String_(this) == ((int64_t)0LL))) {
  {
  return (rae_String){(uint8_t*)"", 0};
  }
  }
  rae_String result = rae_get_rae_List_rae_String_int64_t_(this, ((int64_t)0LL));
  int64_t i = ((int64_t)1LL);
  {
  while ((bool)(i < rae_length_rae_List_rae_String_(this))) {
  {
  result = rae_concat_rae_String_rae_String_(rae_concat_rae_String_rae_String_(result, sep), rae_get_rae_List_rae_String_int64_t_(this, i));
  i = i + ((int64_t)1LL);
  }
  }
  }
...
int main(void) {
  {
  rae_String s = (rae_String){(uint8_t*)"Hello", 5};
...
RAE_UNUSED static void rae_add_rae_List_rae_String_rae_String_(rae_List_rae_String* this, rae_String value) {
  ...
  {
  rae_grow_rae_List_rae_String_(this);
  }
  }
...
RAE_UNUSED static int64_t rae_length_rae_List_rae_String_(rae_List_rae_String* this) {
  {
  return this->length;
  }
}

RAE_UNUSED static rae_String rae_get_rae_List_rae_String_int64_t_(rae_List_rae_String* this, int64_t index) {
  {
