...
void  rae_gb_sprite_set(int64_t i, void* p);
void* rae_gb_sprite_get(int64_t i);
...
void  rae_gb_water_set(int64_t index, void* ptr);
void* rae_gb_water_get(int64_t index);
