...
const char* rae_gb_grass_render_wgsl(void) { return ""; }
...
void  rae_gb_water_set(int64_t index, void* ptr) { (void)index; (void)ptr; }
void* rae_gb_water_get(int64_t index) { (void)index; return (void*)0; }
