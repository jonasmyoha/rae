...
- [x] #39 UI Phase 0: Scene-driven UI design doc + music-player screen PNGs in place. See `rae/examples/98_mobile_ui/DESIGN.md` and `rae/docs/game-proto1-ruics-ecs-reference.md`.
