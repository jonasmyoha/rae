...
- [ ] #40 UI Phase 1a: Add `lib/json.rae` — `JsonValue` tree (`Null/Bool/Number/String/Array/Object`) plus `parseJson(source)` recursive-descent parser and `jsonField/jsonInt/jsonFloat/jsonString/jsonBool` helpers. Tests covering primitives, nested arrays/objects, malformed input. ~150 LOC.
