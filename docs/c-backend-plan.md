...
|-----------|-------------|-------------|
| M1 | CLI plumbing + scaffolding | `rae build --emit-c <file>` prints “Not implemented” but parses options and validates input. |
